...
public class EmployeeDAO implements DataSourceCRUD<Employee> {
    ...
    public void create(Employee employee) {
        try {
            String sql = "INSERT INTO employees(emp_first_name, emp_last_name, emp_email, emp_password, emp_role) VALUES(?, ?, ?, ?, ?)";
    ...
    public void update(Employee employee) {
        ...
        try {
            String sql = "UPDATE employees SET emp_first_name = ?, emp_last_name = ?, emp_email = ?, emp_password = ?, emp_role = ? WHERE emp_id = ?";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.setString(1, employee.getFirstName());
            statement.setString(2, employee.getLastName());
            statement.setString(3, employee.getEmail());
